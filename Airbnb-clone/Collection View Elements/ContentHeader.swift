...
final class ContentHeader<View: ContentConfiguringView>: UICollectionReusableView {
   ...
   static func registration(headers: [Content?]) -> UICollectionView.SupplementaryRegistration<ContentHeader<View>> {
      UICollectionView.SupplementaryRegistration(kind: .header) {
...
class SectionHeaderView: ProgrammaticView, ContentConfiguringView {
